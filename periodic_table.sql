...
--
-- Name: elements unique1; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique1 UNIQUE (symbol);


--
-- Name: elements unique2; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
